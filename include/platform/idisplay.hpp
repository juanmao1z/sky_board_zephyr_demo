...
class IDisplay {
 public:
   ...
   * @return 0 表示成功；负值表示失败。
   */
  virtual int fill_rect(uint16_t x, uint16_t y, uint16_t w, uint16_t h,
   ...
   * @return 0 表示成功；负值表示失败。
   */
  virtual int draw_char(uint16_t x, uint16_t y, char c, uint16_t fg_rgb565, uint16_t bg_rgb565,
   ...
   * @return 0 表示成功；负值表示失败。
   */
  virtual int draw_text(uint16_t x, uint16_t y, const char* text, uint16_t fg_rgb565,
                        uint16_t bg_rgb565, uint8_t scale) noexcept = 0;
   ...
   * @return 0 表示成功；负值表示失败。
   */
  virtual int draw_int(uint16_t x, uint16_t y, int32_t value, uint16_t fg_rgb565,
                       uint16_t bg_rgb565, uint8_t scale) noexcept = 0;
